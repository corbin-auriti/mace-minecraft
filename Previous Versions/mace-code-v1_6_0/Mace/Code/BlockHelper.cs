...
namespace Mace
{
    class BlockHelper
    {
        ...
        {
            if (bm.GetID(x, y, z - 1) == (int)BlockType.RAILS &&
                bm.GetID(x - 1, y, z) == (int)BlockType.RAILS)
            {
                bm.SetData(x, y, z, 8);
            }
            else if (bm.GetID(x, y, z - 1) == (int)BlockType.RAILS &&
                     bm.GetID(x + 1, y, z) == (int)BlockType.RAILS)
            {
                bm.SetData(x, y, z, 9);
            }
            ...
            else if (bm.GetID(x + 1, y, z) == (int)BlockType.RAILS)
            {
                bm.SetData(x, y, z, 1);
            }
            else if (bm.GetID(x - 1, y, z) == (int)BlockType.RAILS)
