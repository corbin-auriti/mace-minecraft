...
namespace Mace
{
    static class BlockHelper
    {
        ...
        public static StairOrientation RotateStairs(int intData, int intRotation)
        {
            StairOrientation soCurrent = (StairOrientation)intData;
            switch (intRotation)
            {
                case 1:
                    switch (soCurrent)
                    {
                        case StairOrientation.ASCEND_NORTH: return StairOrientation.ASCEND_WEST;
                        case StairOrientation.ASCEND_EAST: return StairOrientation.ASCEND_NORTH;
                        case StairOrientation.ASCEND_SOUTH: return StairOrientation.ASCEND_EAST;
                        case StairOrientation.ASCEND_WEST: return StairOrientation.ASCEND_SOUTH;
                        default: Debug.Fail("Invalid switch result"); return soCurrent;
                    }
                case 2:
                    switch (soCurrent)
                    {
                        case StairOrientation.ASCEND_NORTH: return StairOrientation.ASCEND_EAST;
                        case StairOrientation.ASCEND_EAST: return StairOrientation.ASCEND_SOUTH;
                        case StairOrientation.ASCEND_SOUTH: return StairOrientation.ASCEND_WEST;
                        case StairOrientation.ASCEND_WEST: return StairOrientation.ASCEND_NORTH;
                        default: Debug.Fail("Invalid switch result"); return soCurrent;
                    }
                case 3:
                    switch (soCurrent)
                    {
                        case StairOrientation.ASCEND_NORTH: return StairOrientation.ASCEND_SOUTH;
                        case StairOrientation.ASCEND_EAST: return StairOrientation.ASCEND_WEST;
                        case StairOrientation.ASCEND_SOUTH: return StairOrientation.ASCEND_NORTH;
                        case StairOrientation.ASCEND_WEST: return StairOrientation.ASCEND_EAST;
                        default: Debug.Fail("Invalid switch result"); return soCurrent;
                    }
                default:
                    return soCurrent;
