...
namespace Mace
{
    static class SourceWorld
    {
        ...
        static bool _booIncludeItemsInChests;
        static bool _booIncludeGhostdancerSpawners;
        ...
        private static bool ReadBuildings()
        {
            ...
            foreach (XmlNode xmlNode in buildingList)
            {
                ...
                {
                    if (buildingElement.GetElementsByTagName("farm")[0].InnerText.ToLower() == "yes" ||
                        buildingElement.GetElementsByTagName("farm")[0].InnerText.ToLower() == "true")
                    {
                ...
                {
                    if (buildingElement.GetElementsByTagName("mineshaft_entrance")[0].InnerText.ToLower() == "yes" ||
                        buildingElement.GetElementsByTagName("mineshaft_entrance")[0].InnerText.ToLower() == "true")
                    {
                ...
                {
                    if (buildingElement.GetElementsByTagName("mineshaft_section")[0].InnerText.ToLower() == "yes" ||
                        buildingElement.GetElementsByTagName("mineshaft_section")[0].InnerText.ToLower() == "true")
                    {
                ...
                {
                    _AllBuildings[intBuildings].booUnique = (buildingElement.GetElementsByTagName("unique")[0].InnerText.ToLower() == "yes" ||
