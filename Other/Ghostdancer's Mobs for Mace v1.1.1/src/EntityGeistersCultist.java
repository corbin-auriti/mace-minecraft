...
public class EntityGeistersCultist extends EntityVillager
{
    ...
    public EntityGeistersCultist(World world, int i)
    {
        super(world);
        angerLevel = 400;
    ...
    public boolean attackEntityFrom(DamageSource damagesource, int i)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            for (int j = 0; j < list.size(); j++)
            {
                ...
                {
                    EntityGeistersCultist entitygeisterscultist = (EntityGeistersCultist)entity1;
                    entitygeisterscultist.becomeAngryAt(entity);
                }
            }
    ...
    protected void attackEntity(Entity entity, float f)
    {
        if (f < 10F)
        {
            ...
            if (attackTime == 0)
            {
                ...
                worldObj.playSoundAtEntity(this, "random.breath", 1.0F, 1.0F / (rand.nextFloat() * 0.4F + 0.8F));
